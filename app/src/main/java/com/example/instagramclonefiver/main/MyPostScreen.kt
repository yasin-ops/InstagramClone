...
data class PostRow(
    var post1: PostData? = null, var post2: PostData? = null, var post3: PostData? = null
...
@Composable
fun MyPostScreen(vm: InstagramViewModel, navController: NavController) {
    val userData = vm.userData.value
    val isLoading = vm.inProgress.value
    val postsLoading = vm.refreshPostProgress.value
    ...
    Column() {
        Column(modifier = Modifier.weight(1f)) {
            ...
            OutlinedButton(
                onClick = {
                    navigateTO(navController, DestinationScreen.ProfileScreen)
                }, modifier = Modifier
                    .padding(8.dp)
                    .fillMaxWidth(),
...
fun ProfileImage(imageUrl: String?, onClick: () -> Unit) {
    Box(modifier = Modifier
        ...
        Card(
            ...
            Image(
                painter = painterResource(id = com.example.instagramclonefiver.R.drawable.ic_search),
...
fun PostList(
    ...
    if (postsLoading) {
        ...
        Column(
            ...
            if (!isContextLoading) Text(text = "No Posts are available ")
        }
    } else {
